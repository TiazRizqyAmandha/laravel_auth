			...
			<div class="container-fluid">
				<div class="panel panel-headline" style="background-color: #e6e6e6;">
						<div class="panel-heading">
							<h1 class="panel-title" style="margin-top: 10px; font-size: 40px;"><b>Ubah Lowongan Kerja</b></h1>
						</div>
								...
								<form action="/posts/{{$posts->id}}/update" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<select name="gender" class="form-control" id="input_filter" required>
											...
											<option value="ALL" {{!empty($posts->filter) && json_decode($posts->filter)->gender == 'ALL' ? 'selected':''}}>Laki-laki dan Perempuan</option>
