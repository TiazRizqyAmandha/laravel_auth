                    ...
                    <div class="col-md-12">
                        <div class="panel">
                                ...
                                <div class="col-md-8" style="text-align: right; margin-top: 20px;">
                                    ...
                                    <button type="button" class="btn" style="margin-left: 5px; background-color: #ff3399;"><i class="lnr lnr-printer"></i><a href="/kategori/export" style="margin-bottom: 10px; color: white;"> Export Excel</a></button>
                                    <button type="button" class="btn" style="margin-left: 5px; background-color: #ff6600;"><i class="lnr lnr-printer"></i><a href="/kategori/exportpdf" style="margin-bottom: 10px; color: white;"> Export PDF</a></button>
                                    @endif
                                </div>
