...
<body>
    ...
    <div class="ml-3 p-2">
    <p style="font-size: 125%; font-weight:bold">Dear : Anggota Website Alumni</p>
    <p>Hai, ini email dari Website Alumni.</p>
    <p>selamat ! register anda berhasil, selamat bergabung menjadi bagian dari Website Alumni.</p>
    <br>
